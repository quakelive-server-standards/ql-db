  ...
  async version1() {
    ...
    await this.pool.query(`
      CREATE TABLE frag (
        ...
        killer_position_x INTEGER,
        killer_position_y INTEGER,
        killer_position_z INTEGER,
        killer_server_visit_id INTEGER,
        killer_speed INTEGER,
        killer_team VARCHAR(9),
        killer_view_x INTEGER,
        killer_view_y INTEGER,
        killer_view_z INTEGER,
        ...
        victim_position_x INTEGER,
        victim_position_y INTEGER,
        victim_position_z INTEGER,
        victim_server_visit_id INTEGER,
        victim_speed INTEGER,
        victim_team VARCHAR(9),
        victim_view_x INTEGER,
        victim_view_y INTEGER,
        victim_view_z INTEGER,
